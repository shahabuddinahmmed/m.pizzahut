            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div>
                        ...
                        <h5 class="modal-title" id="pizzaWish">Cart Total:<span class="pro_price"> <span id="total">{{ Session::get('grandTotal') }}</span></span></h5>
                    </div>
                </div>
                                    ...
                                    <div class="card mb-4 pizza-wish">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="left-con mt-3">
                                                ...
                                                @else
                                                    <button type="button" class="btn btn-success" onclick="getOkay({{$rec->id}},'2')">Add <span class="pro_price"> {{ $rec->price_family }}</span></button>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
