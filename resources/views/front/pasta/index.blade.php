            ...
            <div class="scroll-content" id="productList">
                ...
                @foreach($products as $product)
                    ...
                    if ($product->price_family > 0) {
                        $price = get_show_price($product->price_family,$product->sd);
//                        $price = $product->price_family;

                    } elseif ($product->price_medium > 0) {
//                        $price = $product->price_medium;
                        $price = get_show_price($product->price_medium,$product->sd);
                    } elseif ($product->price_personal > 0) {
//                        $price = $product->price_personal;
                        $price = get_show_price($product->price_personal,$product->sd);
                    }
                    ?>
                    ...
                    <div class="product_card">
                        <form class="addToCart" action="#" method="post">
                            <div class="pro_image">
                                ...
                                @else
                                    <img src="{{m_asset('/')}}front/assets/imgs/noimage.png" width="120px">
                                @endif
                            ...
                            <div class="pro_details">
                                ...
                                @if($product->price_family > 0)
                                    ...
                                    <input type="hidden" name="product_name"
                                           value="{{$product->title.'<br/>'.'Size - Regular'}}">
                                ...
                                @elseif($product->price_medium > 0)
                                    ...
                                    <input type="hidden" name="product_name"
                                           value="{{$product->title.'<br/>'.'Size - Lighter'}}">
                                    <input type="hidden" name="product_price" value="{{$product->price_medium}}"
                                           min="1">
                                    <input type="hidden" name="sd" value="{{round($product->price_medium/100*10)}}">
                                    <p><span>{{$product->title}}</span><span
                                ...
                                @elseif($product->price_personal > 0)
                                    ...
                                    <input type="hidden" name="product_price" value="{{get_show_price($product->price_personal,$product->sd)}}"
                                           min="1">
                                    <input type="hidden" name="sd" value="{{round($product->price_personal/100*10)}}">
                                    <p><span>{{$product->title}}</span><span
                                                class="pro_price mobile_pro_price">{{get_show_price($product->price_personal,$product->sd)}}</span></p>
                                @endif
                                        ...
                                        @if($product->price_family > 0)
                                            <div class="col col-lg col-sm-12" style="border-right:3px solid white">
                                                <input type="radio" name="pizza_size" data-size="price_family"
                                                       ...
                                                       data-title="{{'Size - Regular'}}"
                                                       data-price="{{get_show_price($product->price_family,$product->sd)}}"
                                                       data-product_number={{$product_number++}}
                                                               id="family_size_{{$product->id}}">
                                                <label for="family_size_{{$product->id}}" class="product_size_label">Regular</label>&nbsp;&nbsp;&nbsp;
                                            </div>
                                            @php($checked = '')
                                        @endif
                                        @if($product->price_medium > 0)
                                            <div class="col col-lg col-sm-12">
                                                <input type="radio" name="pizza_size" data-size="price_medium"
                                                       ...
                                                       data-title="{{'Size - Lighter'}}"
                                                       data-price="{{get_show_price($product->price_medium,$product->sd)}}"
                                                       data-product_number={{$product_number++}}
                                                               id="medium_size_{{$product->id}}">
                                                <label for="medium_size_{{$product->id}}" class="product_size_label">Lighter</label>&nbsp;&nbsp;&nbsp;
                                            </div>
                                            @php($checked = '')
                                        @endif
                                        @if($product->price_personal > 0)
                                            <div class="col col-lg col-sm-12" style="border-left:3px solid white;">
                                                <input type="radio" name="pizza_size" data-size="price_personal"
                                                       ...
                                                       data-price="{{get_show_price($product->price_personal,$product->sd)}}"
                                                       data-product_number={{$product_number}}
                                ...
                                <div class="info pan_sfo_text">
                                    <div class="row ml-0 mr-0">
                                        <div class="col-md-4 crust_content_display">
                                            <img class="tawhid_shap" src="{{asset('/')}}front/assets/imgs/spaghetti.svg" alt="" >
                                            <img class="tawhid_shap" src="{{asset('/')}}front/assets/imgs/fusilli.svg" alt="" >
                                            <img class="tawhid_shap" src="{{asset('/')}}front/assets/imgs/panne.svg" alt="" >
                                            <img class="tawhid_shap" src="{{asset('/')}}front/assets/imgs/macaroni.svg" alt="" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="info pan_sfo_text">
                                    <div class="row ml-0 mr-0">
                                        ...
                                        <div class="col-md-4 cust_pan_padding" style="display: none;">
                                        ...
                                        <div class="col-md-4 crust_content_display cust_pan_padding">
                                            ...
                                            @foreach($crusts as $k=>$ingredient)
                                                <input type="radio" name="pizza_crust" data-size="price_medium"
                                                       ...
                                                       data-price_medium="{{get_show_price($ingredient->price_medium,$ingredient->sd)}}"
                                                       data-price_personal="{{get_show_price($ingredient->price_personal,$ingredient->sd)}}"
                                                       data-price_family="{{get_show_price($ingredient->price_family,$ingredient->sd)}}"
                                                       data-crust_number="{{$k}}"
                                                       id="{{'crust_'.$k.$product->id}}"
                                                        {{ $k == 0 ? "checked" : ""}}
                                                >
                                                <label for="{{'crust_'.$k.$product->id}}"
                                                       class="product_size_label">{{$ingredient->name}}
                                                    @if($k<3)&nbsp;| @endif
                                                </label>
                                            @endforeach
                                        </div>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <div class='pizzaPrice'
                                                                         style='visibility: hidden;height: 0px;'>{{get_show_price($product->price_family,$product->sd)}}</div>
                                                                </td>
                                                        ...
                                                        @if($product->price_medium > 0)
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <div class='pizzaPrice'
                                                                         style='visibility: hidden;height: 0px;'>{{get_show_price($product->price_medium,$product->sd)}}</div>
                                                                </td>
                                                                <td class='custom_piza_check' data-name='product'
                                                        ...
                                                        @if($product->price_personal > 0)
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <div class='pizzaPrice'
                                                                         style='visibility: hidden;height: 0px;'>{{get_show_price($product->price_personal,$product->sd)}}</div>
                                                                </td>
                                                                <td class='custom_piza_check' data-name='product'
                                                                    data-size_id="{{$product->id.'009'}}"
                                                                    data-price="{{get_show_price($product->price_personal,$product->sd)}}"
                                                ...
                                                <div id="crust_{{$product->id}}" class="collapse in">
                                                    <table width="100%">
                                                        ...
                                                        @if(count($all_crust) > 0)
                                                            ...
                                                            <tr data-price_family="{{get_show_price($ingredient1['price_family'],$ingredient1['sd'])}}"
                                                                data-price_medium="{{get_show_price($ingredient1['price_medium'],$ingredient1['sd'])}}"
                                                                data-price_personal="{{get_show_price($ingredient1['price_personal'],$ingredient1['sd'])}}">
                                                                <td>
                                                        ...
                                                        @if(count($all_crust) > 1)
                                                            ...
                                                            <tr data-price_family="{{get_show_price($ingredient2['price_family'],$ingredient2['sd'])}}"
                                                                data-price_medium="{{get_show_price($ingredient2['price_medium'],$ingredient2['sd'])}}"
                                                                data-price_personal="{{get_show_price($ingredient2['price_personal'],$ingredient2['sd'])}}"
                                                        ...
                                                        @endif
                                                        @if(count($all_crust) > 2)
                                                            @php($ingredient3 = $all_crust[2])
                                                            <tr data-price_family="{{get_show_price($ingredient3['price_family'],$ingredient3['sd'])}}"
                                                                data-price_medium="{{get_show_price($ingredient3['price_medium'],$ingredient3['sd'])}}"
                                                                data-price_personal="{{get_show_price($ingredient3['price_personal'],$ingredient3['sd'])}}">
                                                                <td>
                                                                    @if($ingredient3->image)
                                                                        <img class="toppings_icons"
                                                                             src="{{m_asset($ingredient3->image)}}"
                                                                             alt="">
                                                                    @else
                                                                        <img class="toppings_icons"
                                                                             src="{{asset('/')}}front/assets/imgs/Dec-21-pan.png"
                                                                ...
                                                                <td class='group-item-price'>
                                                                    <span class="pizzaPrice">{{$ingredient3[$pizza_size]}}</span>
                                                                </td>
                                                                <td class="custom_piza_check"
                                                                    data-name="crust"
                                                                    data-ingredient_id="{{$ingredient3->id}}"
                                                                    data-size_id="{{$product->id.'00'.$ingredient3->id}}">
                                                                    <i class="fa fa-plus text-right"
                                                                       aria-hidden="true"></i>
                                                                </td>
                                                            </tr>
                                                        @endif
                                                        @if(count($all_crust) > 3)
                                                            @php($ingredient4 = $all_crust[3])
                                                            <tr data-price_family="{{get_show_price($ingredient4['price_family'],$ingredient4['sd'])}}"
                                                                data-price_medium="{{get_show_price($ingredient4['price_medium'],$ingredient4['sd'])}}"
                                                                data-price_personal="{{get_show_price($ingredient4['price_personal'],$ingredient4['sd'])}}">
                                                                <td>
                                                                    @if($ingredient4->image)
                                                                        <img class="toppings_icons"
                                                                             src="{{m_asset($ingredient4->image)}}"
                                                                             alt="">
                                                                    @else
                                                                        <img class="toppings_icons"
                                                                             src="{{asset('/')}}front/assets/imgs/Dec-21-pan.png"
                                                                ...
                                                                <td class='group-item-price'>
                                                                    <span class="pizzaPrice">{{$ingredient4[$pizza_size]}}</span>
                                                                </td>
                                                                <td class="custom_piza_check"
                                                                    data-name="crust"
                                                                    data-ingredient_id="{{$ingredient4->id}}"
                                                                    data-size_id="{{$product->id.'00'.$ingredient4->id}}">
                                                                    <i class="fa fa-plus text-right"
                                                                       aria-hidden="true"></i>
                                                                </td>
                                                            </tr>
                                                ...
                                                <div id="toppings_{{$product->id}}" class="collapse in toppings">
                                                    <table width="100%">
                                                        ...
                                                        @foreach($toppings as $addons)
                                                            <tr data-price_family="{{get_show_price($addons['price_family'],$addons['sd'])}}"
                                                                data-price_medium="{{get_show_price($addons['price_medium'],$addons['sd'])}}"
                                                                data-price_personal="{{get_show_price($addons['price_personal'],$addons['sd'])}}">
                                                                <td>
                                                                    @if($addons->image)
            ...
            function changePrize(_this) {
                ...
                let generateProductId = function () {
                    ...
                    if (item_name == 'crust_display' || item_name == 'crust') {
                        ...
                        }else if(crust_value == 6) {
                            size_id = parseInt(selected_product_size_id) + 3;
                        }else if(crust_value == 7){
                            size_id = parseInt(selected_product_size_id) + 4;
                        }else if(crust_value == 8){
                            size_id = parseInt(selected_product_size_id) + 5;
                        }
