    ...
    <div class="main-content">
        ...
        <div id="Pizza">
            <div class="scroll-content" id="productList">
                ...
                @php($product_name = '')
                <h1 class="ribbon">
                    <strong class="ribbon-content">{{__('PAN PIZZA')}}</strong>
                </h1>
                    ...
                    <div class="product_card">
                        <form class="addToCart" action="#" method="post">
                            ...
                            <div class="pro_details">
                                ...
                                @if($product->price_personal > 1000000)
                                    ...
                                    <input type="hidden" name="product_price" value="{{get_show_price($product->price_personal,$product->sd)}}"
                                           min="1">
                                    <input type="hidden" name="product_raw_price" value="{{get_show_price($product->price_personal,$product->sd)}}" min="1">
                                ...
                                @elseif($product->price_medium > 0)
                                    ...
                                    <input type="hidden" name="product_price" value="{{get_show_price($product->price_medium,$product->sd)}}"
                                           min="1">
                                    <input type="hidden" name="product_raw_price" value="{{get_show_price($product->price_medium,$product->sd)}}" min="1">
                                    <input type="hidden" name="sd" value="{{round($product->price_medium/100*10)}}">
                                    <p><span>{{$product->title}}</span><span
                                                class="pro_price mobile_pro_price">{{get_show_price($product->price_medium,$product->sd)}}</span></p>
                                @elseif($product->price_family > 0)
                                    @php($pizza_size = 'price_family')
                                    <input type="hidden" name="product_size_id" value="{{$product->id.'000'}}">
                                    <input type="hidden" name="product_name"
                                           value="{{$product->title.'<br/>'.'Size - Family'}}">
                                    <input type="hidden" name="product_price" value="{{get_show_price($product->price_family,$product->sd)}}"
                                           min="1">
                                    <input type="hidden" name="product_raw_price" value="{{get_show_price($product->price_family,$product->sd)}}" min="1">
                                    <input type="hidden" name="sd" value="{{round($product->price_family/100*10)}}">
                                    <p><span>{{$product->title}}</span><span
                                                class="pro_price mobile_pro_price">{{get_show_price($product->price_family,$product->sd)}}</span></p>
                                @endif
        ...
        $(function () {
            ...
            function changePrize(_this) {
                ...
                let calculateTotalPrice = function () {
                    ...
                    current_product.find('input[name=product_raw_price]').val(product_raw_price);
                ...
                let generateProductId = function () {
                    ...
                    if (item_name == 'crust_display' || item_name == 'crust') {
                        ...
                        if(crust_value == 'cheesy_bites'){
                            size_id = selected_product_size_id;
                        }else if(crust_value == 'golden_surprise') {
                        ...
                        if (selected_crust_value == 'golden_surprise') {
                ...
                if (item_name == 'product') {
                    ...
                    if(crust_id == 'pan' || crust_id =='sfo'){
                        if (product_size == 'price_medium') {
                    ...
                    let crust_id = $(_this).val();
                    let product_size = 'price_medium';
                    if(crust_id !='sfo'){
                        product_size = current_product.find("input[name='pizza_size']:checked").data('size');
                    }
                    generateProductId();
                    $.when(toppingsPrice(product_size)).done(function () {
                        calculateTotalPrice();
...
//Price change as medium and family in
            ...
            productList.on('click', '.addToPrizeCart', function (event) {
                ...
                var product_raw_price = form.find('input[name=product_raw_price]').val();
