                    ...
                    <div class="login_wrapper">
                        <div class="input_field">
                            ...
                            <div class="col-md-12 my-5">
                                <form method="GET" action="{{route('dining-info')}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="store_id" id="storeId" required="required">
                                            ...
                                            @endforeach
                                            {{--<option value="573" selected="selected">C.G Road</option>--}}
                                            {{--<option value="610">Prahlad Nagar</option>--}}
                                            {{--<option value="500">Shapath SG Road</option>--}}
                                        </select>
                                    </div>
