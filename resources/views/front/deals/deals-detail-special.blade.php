                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        @foreach($supreme_lien_pizza as $product)
                                            <div class="col-xs-6">
                                                <div class="polaroid pizzaImage"
                                                    ...
                                                    @endif
                                                    <p class="short_desc">{{$product->title}}</p>
                                                    <p class="category" style="display: none">supremes_line</p>
                                                    <p class="sd" style="display: none">1</p>
                                                        <button class="btn btn-deals---btn">Add + <span
                                                                    class="pro_price">{{ get_show_price($product['price_family'],$product['sd']) }}</span></button>
                                        ...
                                        @if(!empty($super_supreme_pizza))
                                            <div class="col-xs-12 text-center">
                                                <div class="toolbar-title toolbar-title-md deals-category-title"> Super Supremes
                                                </div>
                                            </div>
                                        @endif
                                        @foreach($super_supreme_pizza as $product)
                                            <div class="col-xs-6">
                                                <div class="polaroid pizzaImage"
                                                    ...
                                                    @endif
                                                    <p class="short_desc">{{$product->title}}</p>
                                                    <p class="category" style="display: none">supper_supremes</p>
                                                    <p class="sd" style="display: none">1</p>
                                                     <button class="btn btn-deals---btn">Add + <span
                                                                    class="pro_price">{{ get_show_price($product['price_family'],$product['sd']) }}</span></button>
                                                </div>
                                            ...
                                            @foreach($cheesy_bites_fav as $product)
                                                <div class="col-xs-6">
                                                    <div class="polaroid pizzaImage"
                                                        ...
                                                        @endif
                                                        <p class="short_desc">{{$product->title}}</p>
                                                        <p class="category" style="display: none">cheesy_bites_favorites_line</p>
                                            ...
                                            @foreach($cheesy_bites as $product)
                                                <div class="col-xs-6">
                                                    <div class="polaroid pizzaImage"
                                                        ...
                                                        @endif
                                                        <p class="short_desc">{{$product->title}}</p>
                                                        <p class="category" style="display: none">cheesy_bites_supremes_line</p>
                                                        <p class="sd" style="display: none">0</p>
                                                            <button class="btn btn-deals---btn">Add + <span
                                                                        class="pro_price">{{ get_show_price($product['price_family'],$product['sd']) }}</span></button>
                                            ...
                                            @foreach($golden_surprise_fav as $product)
                                                <div class="col-xs-6">
                                                    <div class="polaroid pizzaImage"
                                                        ...
                                                        @endif
                                                        <p class="short_desc">{{$product->title}}</p>
                                                        <p class="category" style="display: none">sausage_crust_favorites_line</p>
                                                        <p class="sd" style="display: none">0</p>
                                                            <button class="btn btn-deals---btn">Add + <span
                                                                        class="pro_price">{{ get_show_price($product['price_family'],$product['sd']) }}</span></button>
                                            ...
                                            @foreach($golden_surprise as $product)
                                                <div class="col-xs-6">
                                                    <div class="polaroid pizzaImage"
                                                        ...
                                                        @endif
                                                        <p class="short_desc">{{$product->title}}</p>
                                                        <p class="category" style="display: none">sausage_crust_supremes_line</p>
                                                        <p class="sd" style="display: none">0</p>
                                                            <button class="btn btn-deals---btn">Add + <span
                                                                        class="pro_price">{{ get_show_price($product['price_family'],$product['sd']) }}</span></button>
                                                    ...
                                                    @foreach($new as $product)
                                                        <div class="col-xs-6">
                                                            <div class="polaroid pizzaImage"
                                                                ...
                                                                @endif
                                                                <p class="short_desc">{{$product->title}}</p>
                                                                <p class="category" style="display: none">{{ strtolower(str_replace([' ','(',')'], ['_','_',''], $key)) }}</p>
                                                                <p class="sd" style="display: none">0</p>
                                                                    <button class="btn btn-deals---btn">Add + <span
                                                                                class="pro_price">{{ get_show_price($product['price_family'],$product['sd']) }}</span></button>
                    ...
                    <div class="main-content">
                        ...
                        <div class="clearfix">
                            <div class="scroll-content" style="margin-top: 120px; margin-bottom: 0px;">
                                <!--notification menu end -->
                                <div class="container">
                                    <div class="row" id="favorites_line">
                                    ...
                                    <div class="row" id="supremes_line">
                                    ...
                                    <div class="row" id="supper_supremes">
                                    ...
                                    <div class="row" id="cheesy_bites_favorites_line">
                                        @if($cheesy_bites_fav!=null)
                                            <div class="col-xs-12 text-center">
                                    ...
                                    <div class="row" id="cheesy_bites_supremes_line">
                                        @if($cheesy_bites!=null)
                                            <div class="col-xs-12 text-center">
                                                <div class="toolbar-title toolbar-title-md deals-category-title"> Cheesy Bites(Supremes Line)
                                                </div>
                                            </div>
                                            @foreach($cheesy_bites as $product)
                                                <div class="col-xs-6">
                                    ...
                                    <div class="row" id="sausage_crust_favorites_line">
                                        @if($golden_surprise_fav!=null)
                                            <div class="col-xs-12 text-center">
                                                <div class="toolbar-title toolbar-title-md deals-category-title">
                                                    Sausage Crust (Favorites Line)
                                    ...
                                    <div class="row" id="sausage_crust_supremes_line">
                                        @if($golden_surprise!=null)
                                            <div class="col-xs-12 text-center">
                                                <div class="toolbar-title toolbar-title-md deals-category-title">
                                                    Sausage Crust(Supremes Line)
                                ...
                                <div class="row" id="new_line">
                                    @if($new_line!=null)
                                        @foreach($new_line as $key=>$new)
                                            <div class="row"
                                                 id="{{strtolower(str_replace([' ','(',')'], ['_','_',''], $key))}}">
                                            <div class="col-xs-12 text-center">
        ...
        $(function () {
            ...
            $('#chooseFreePizza').on('show.bs.modal', function (event) {
                ...
                modal.off('click').on('click', '.pizzaImage', function (e) {
                    ...
                    let tcate = cat.replaceAll("_", " ").toUpperCase();
            ...
            $('#choosePizza').on('show.bs.modal', function (event) {
                ...
                modal.off('click').on('click', '.pizzaImage', function (e) {
                    ...
                    @if($deal->id==14)
                    if(document.getElementById("favorites_line")) document.getElementById("favorites_line").style.display = "none";
                    if(document.getElementById("supremes_line")) document.getElementById("supremes_line").style.display = "none";
                    if(document.getElementById("supper_supremes")) document.getElementById("supper_supremes").style.display = "none";

                    if(document.getElementById("thin_crust_favorites_line")) document.getElementById("thin_crust_favorites_line").style.display = "none";
                    if(document.getElementById("thin_crust_supremes_line")) document.getElementById("thin_crust_supremes_line").style.display = "none";
                    if(document.getElementById("thin_crust_supper_supremes_line")) document.getElementById("thin_crust_supper_supremes_line").style.display = "none";

                    if(document.getElementById("cheesy_bites_favorites_line")) document.getElementById("cheesy_bites_favorites_line").style.display = "none";
                    if(document.getElementById("cheesy_bites_supremes_line")) document.getElementById("cheesy_bites_supremes_line").style.display = "none";
                    if(document.getElementById("cheesy_bites_supper_supremes_line")) document.getElementById("cheesy_bites_supper_supremes_line").style.display = "none";

                    if(document.getElementById("sausage_crust_favorites_line")) document.getElementById("sausage_crust_favorites_line").style.display = "none";
                    if(document.getElementById("sausage_crust_supremes_line")) document.getElementById("sausage_crust_supremes_line").style.display = "none";
                    if(document.getElementById("sausage_crust_supper_supremes_line")) document.getElementById("sausage_crust_supper_supremes_line").style.display = "none";

                    if (['favorites_line', 'supremes_line', 'supper_supremes'].includes(cat)) {
                        if(document.getElementById("supremes_line")) document.getElementById("supremes_line").style.display = "inline-flex";
                        if(document.getElementById("supper_supremes")) document.getElementById("supper_supremes").style.display = "inline-flex";
                        if(document.getElementById("favorites_line")) document.getElementById("favorites_line").style.display = "inline-flex";
                    } else if (['cheesy_bites_favorites_line', 'cheesy_bites_supremes_line', 'cheesy_bites_supper_supremes_line'].includes(cat)) {
                        if(document.getElementById("cheesy_bites_favorites_line")) document.getElementById("cheesy_bites_favorites_line").style.display = "inline-flex";
                        if(document.getElementById("cheesy_bites_supremes_line")) document.getElementById("cheesy_bites_supremes_line").style.display = "inline-flex";
                        if(document.getElementById("cheesy_bites_supper_supremes_line")) document.getElementById("cheesy_bites_supper_supremes_line").style.display = "inline-flex";
                    } else if (['sausage_crust_favorites_line', 'sausage_crust_supremes_line', 'sausage_crust_supper_supremes_line'].includes(cat)) {
                        if(document.getElementById("sausage_crust_favorites_line")) document.getElementById("sausage_crust_favorites_line").style.display = "inline-flex";
                        if(document.getElementById("sausage_crust_supremes_line")) document.getElementById("sausage_crust_supremes_line").style.display = "inline-flex";
                        if(document.getElementById("sausage_crust_supper_supremes_line")) document.getElementById("sausage_crust_supper_supremes_line").style.display = "inline-flex";
                    }else if (['thin_crust_favorites_line', 'thin_crust_supremes_line', 'thin_crust_supper_supremes_line'].includes(cat)) {
                        if(document.getElementById("thin_crust_favorites_line")) document.getElementById("thin_crust_favorites_line").style.display = "inline-flex";
                        if(document.getElementById("thin_crust_supremes_line")) document.getElementById("thin_crust_supremes_line").style.display = "inline-flex";
                        if(document.getElementById("thin_crust_supper_supremes_line")) document.getElementById("thin_crust_supper_supremes_line").style.display = "inline-flex";
                    }
                    @endif
