...
function initMap({ sklLatLng, setLocation, setStore }) {
  var shewraparaCoords = [
    { lat: 23.8079101, lng: 90.3697894 },
    { lat: 23.8025049, lng: 90.3619946 },
    { lat: 23.7736285, lng: 90.3702643 },
    { lat: 23.77716, lng: 90.38095 },
    { lat: 23.78785, lng: 90.38843 },
    { lat: 23.79819, lng: 90.38703 },
  ];
  var shewraparaOutlet = new google.maps.LatLng(23.791973, 90.374087);
  var banasreeCoords = [
    { lat: 23.7761, lng: 90.42623 },
    { lat: 23.7755, lng: 90.43157 },
    { lat: 23.76714, lng: 90.42963 },
    { lat: 23.76494, lng: 90.43777 },
    { lat: 23.7625, lng: 90.43839 },
    { lat: 23.76162, lng: 90.44541 },
    { lat: 23.75429, lng: 90.44384 },
    { lat: 23.75862, lng: 90.41793 },
    { lat: 23.76372, lng: 90.41192 },
    { lat: 23.76927, lng: 90.4159 },
    { lat: 23.76734, lng: 90.4231 },
  ];
  var banasreeOutlet = new google.maps.LatLng(23.766091, 90.42594);
  var adaborCoords = [
    { lat: 23.76015, lng: 90.37278 },
    { lat: 23.7776514, lng: 90.3668026 },
    { lat: 23.7786398, lng: 90.3539282 },
    { lat: 23.77804, lng: 90.35144 },
    { lat: 23.76997, lng: 90.34712 },
    { lat: 23.7577832, lng: 90.3570307 },
  ];
  ...
  var branches = [
    {
      tag: "gulshanTriangle",
      name: "Pizza Hut Delivery Gulshan",
      location:
        "Road # 140, SE(F)- 1, Bir Uttam Mir Shawkat Ali Sarak, (South Avenue), Gulshan - 1, Dhaka- 1212.",
    },
    {
      tag: "gulshan2Triangle",
      name: "Pizza Hut Delivery RM Center",
      location:
        "House- 101( 2nd Floor), Gulshan Avenue, Gulshan - 2, Dhaka-1212",
    },
    {
    ...
    },
    {
      ...
      name: "Pizza Hut Delivery Dhanmondi2",
      location:
        "Dr. Refat Ullahs Happy Arcade, House-03, Road-03, Dhanmondi, Dhaka",
    },
    {
      tag: "bailyTriangle",
      name: "Pizza Hut Baily Road",
      location:
        "3, New Baily Road, 10, Natok Sarani, Gold Hunt Shopping Complex, Dhaka.",
    },
    {
      tag: "uttaraTriangle",
    ...
    {
      tag: "uttara2Triangle",
      name: "Pizza Hut Delivery Uttara2",
      location:
        "H#06, Road#02, Ahmed Plaza (Gr. Flr), Sector-03, Uttara, Dhaka-1230",
    },
    {
      tag: "bhataraTriangle",
      name: "Pizza Hut Delivery Bhatara",
      location:
        "Adept N. R. Complex, Plot- Ka 5/2, Bashundhara Link Road, Jagannathpur, Badda, Dhaka-1229",
    },
    {
      tag: "bananiTriangle",
    ...
    },
    {
      ...
      location:
        "Spring Rahmat E Tuba, Plot-132, Road-2, Block- A, Section- 12,  Mirpur, Dhaka",
    },
    {
      tag: "mirpur2Triangle",
      name: "Pizza Hut Delivery Sony",
      location:
        "Sony Cinema Bhaban, Ist Floor, Plot-1, Block-D,Sector-02, Mirpur, Dhaka-1216",
    },
    {
      tag: "wariTriangle",
    ...
    {
      tag: "savarTriangle",
      name: "Pizza Hut Delivery Savar",
      location:
        "M.K Tower, 1st Floor (right side), Holding-B-16/1 Jaleshwar, Savar Union",
    },
    {
      tag: "coxTriangle",
      name: "Pizza Hut Delivery Cox Bazar",
      location:
        "Plot No 08, Block A, Near At Long Beach Out Side, Kalatoli Road, New Beach Rd, Coxs Bazar-4700",
    },
    {
      tag: "chittagongTriangle",
      name: "Pizza Hut Chittagong",
      location:
        "Plot No 08, Block A, Near At Long Beach Out Side, Kalatoli Road, New Beach Rd, Coxs Bazar-4700",
    },
    {
      tag: "sylhetTriangle",
      name: "Pizza Hut Sylhet",
      location:
        "Plot No 08, Block A, Near At Long Beach Out Side, Kalatoli Road, New Beach Rd, Coxs Bazar-4700",
    },
    {
      tag: "jamunaTriangle",
      name: "Pizza Hut Jamuna Future Park",
      location:
        "Plot No 08, Block A, Near At Long Beach Out Side, Kalatoli Road, New Beach Rd, Coxs Bazar-4700",
    },
    {
      tag: "adaborTriangle",
      name: "Pizza Hut FCD Adabor",
      location:
        "Plot-1107/A, 1105/B (Shiuly), Baitul Aman Housing Society, Adabor, Dhaka-1207",
    },
    {
      tag: "banasreeTriangle",
      name: "Pizza Hut FCD Banasree",
      location:
        "Amena Dream Park, A7, A8, Main Road, Banasree, Rampura, Dhaka 1219",
    },
    {
      tag: "shewraparaTriangle",
      name: "Pizza Hut FCD Shewrapara",
      location: "Mehdi Mollik Plaza, 218/9, West Kafrul, Mirpur, Dhaka - 1206",
    },
  ];
    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        function (position) {
          ...
          let pos;
          let searchCustom = JSON.parse(sessionStorage.getItem("location"));
          if (
            searchCustom.searchLocation === "Home" ||
            searchCustom.searchLocation === "Google"
          ) {
            ...
            pos = {
              lat: searchCustom.lat,
              lng: searchCustom.lng,
            };
          }
  ...
  // adaborTriangle.setMap(map);
  // banasreeTriangle.setMap(map);
  // shewraparaTriangle.setMap(map);
}
