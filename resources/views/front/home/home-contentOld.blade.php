            ...
            <!-- .selection -->
                ...
                <div class="container-fluid" style="background-color: #000; height: 370px; padding-top:20px;">
                    ...
                    <nav class="footer_text"
                        ...
                        <p style="margin-bottom: 0;">© 2019 , Pizza Hut Bangladesh. All rights reserved.</p>
                    </nav>
                </div>
            </div>
        </div><!-- End of .clearfix -->
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 p-0">
                                ...
                                <a href={{url($popupImageData->redirect_url)}} class="checkLocation"> <img src="{{m_asset('storage/'.$popupImageData->image_path)}} " alt="" style="max-width: 100%; margin-top: -35px"></a>
                                {{--<a href={{url($popupImageData->redirect_url)}} class="checkLocation"> <img src="{{ url('') }}/attached_images/deals/7/WOW.jpg" alt="" style="max-width: 100%; margin-top: -35px"></a>--}}
                            </div>
                        </div>
                    </div>
                </div>
