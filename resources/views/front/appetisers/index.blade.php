    ...
    <div class="main-content">
        ...
        <div id="Pizza">
            <div class="scroll-content" id="productList">
                ...
                @php($product_name = '')
                {{--<h1 class="ribbon">--}}
                    {{--<strong class="ribbon-content">{{'Appetisers'}}</strong>--}}
                {{--</h1>--}}
                @foreach($products as $product)
                        @if($product_name != $product->category_name)
                            <h1 class="ribbon">
                                <strong class="ribbon-content">{{$product->category_name}}</strong>
                            </h1>
                        @endif
                    {{--@if($product_name != $product->category_name)--}}
                            ...
                            <div class="pro_details">
                                ...
                                @if($product->price_family > 0)
                                    ...
                                    <p><span>{{$product->title}}</span><span
                                                class="pro_price">{{get_show_price($product->price_family,$product->sd)}}</span></p>
                                @elseif($product->price_medium > 0)
                                    ...
                                    <p><span>{{$product->title}}</span><span
                                                class="pro_price">{{get_show_price($product->price_medium,$product->sd)}}</span></p>
                                @elseif($product->price_personal > 0)
                                    ...
                                    <p><span>{{$product->title}}</span><span
                                                class="pro_price">{{get_show_price($product->price_personal,$product->sd)}}</span></p>
                                @endif
