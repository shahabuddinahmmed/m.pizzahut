                                    ...
                                    <div class="row">
                                            ...
                                            @foreach($crown as $product)
                                                <div class="col-xs-6">
                                                    <div class="polaroid pizzaImage"
                                                         data-price_family="{{get_show_price($product['price_medium'],$product['sd'])}}">
                                                        @if($product->image)
                                                        ...
                                                        {{--                                                         class="pro_price">{{$product['price_family']}}</span></button>--}}
                                        ...
                                        @if($golden_surprise_fav!=null)
                                            @if(!empty($golden_surprise_fav))
                                                <div class="col-xs-12 text-center">
                                                    <div class="toolbar-title toolbar-title-md deals-category-title">
                                                        Golden Surprise (Favourite Line)
                                                    </div>
                                                </div>
                                            @endif
                            ...
                            <div class="scroll-content" style="margin-top: 120px; margin-bottom: 0px;">
                                ...
                                <div class="container">
                                        ...
                                        @foreach($favorite_lien_pizza as $product)
                                            <div class="col-xs-6">
                                                ...
                                                >
                                                    ...
                                                    <p class="sd" style="display: none">1</p>
                                                    {{--                                                    <a href="" class="btn btn-deals---btn">Add + <span--}}
                                                    {{--                                                                class="pro_price">{{$product['price_family']}}</span></a>--}}
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
                                    ...
                                    <div class="row" id="golden_fav">
                                        @if($golden_surprise_fav!=null)
                                            <div class="col-xs-12 text-center">
                                                <div class="toolbar-title toolbar-title-md deals-category-title"> Golden
                                                    Surprise (Favourite Line)
                                                </div>
                                            </div>
                                            @foreach($golden_surprise_fav as $product)
                                                <div class="col-xs-6">
