        ...
        <div class="clearfix">
            <div class="scroll-content" style="margin-top: 120px;">
                ...
                <div class="container mainContainer" style="border-bottom: 1px solid #efefef;">
                    ...
                    <input type="hidden" name="product_size" value="{{$deal->pizza_size}}">
    ...
    <script>
        $(function () {
            ...
            function setPizzaName() {
                ...
                let product_size_label = (product_size == 1) ? 'Size - Family' : (product_size == 2 ? 'Size - Medium' : 'Size - Personal');
                ...
                rootParent.find('input[name=product_name]').val(product_raw_name + '<br/>' + product_size_label + '<br/>' + full_name + '<br/>' + long_description);
            }
